...
# python main.py --type_damaged viem_thuc_quan_20230620 --type_pretrained im1k --task segmentation --root_path "/mnt/tuyenld/data/endoscopy/" --type_seg "TonThuong" --num_freeze 0 --max_lr 1e-6 --min_lr 2e-5 --lr 1e-3 --img_size 512 --gpu "1" --batch_size 1 --type_opt "AdamW" --type_encoder "target_encoder"
