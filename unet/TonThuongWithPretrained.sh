...
python main.py --type_pretrained endoscopy --task classification --type_cls vitri --num_freeze 10 --lr 1e-3 --root_path "/mnt/tuyenld/data/endoscopy/" --img_size 336
...
python main.py --type_pretrained endoscopy --task classification --type_cls vitri --num_freeze 0 --lr 1e-3 --root_path "/mnt/tuyenld/data/endoscopy/" --img_size 336
