...
def get_vision_transformer(backbone: str, model: str, img_size: int = 1024):
    ...
    if backbone == "ijepa":
        if model == "vit_b":
            ...
            raise ValueError(f"{model} is not supported by IJEPA. Currently vit_b, vit_l, vit_h are supported.")

    else:
        raise ValueError("The UNETR supported backbones is `ijepa`. Please choose either of the two")
